                ...
                <div class="row">
                    ...
                    {/* <ul class="footer-list">
                            <li class="footer-item">
                                ...
                                <a href="https://www.facebook.com/xiaoming4869" class="footer-item-link special-item">
                                    Facebook
                                </a>
                            </li>
                            <li class="footer-item">
                                <i class="fa-brands fa-instagram"></i>
                                <a href="https://www.instagram.com/liang_mingg/" class="footer-item-link special-item">
                                    Instagram
                                </a>
                            </li>
                            <li class="footer-item">
                                <i class="fa-brands fa-tiktok"></i>
                                <a href="https://www.tiktok.com/@xiaoming4869" class="footer-item-link special-item">
                                    Tiktok
                                </a>
                            </li>
                            <li class="footer-item">
                                <i class="fa-brands fa-github"></i>
                                <a href="https://github.com/TieuMinhh" class="footer-item-link special-item">
                                    Github
                                </a>
                            </li>
                            <li class="footer-item">
