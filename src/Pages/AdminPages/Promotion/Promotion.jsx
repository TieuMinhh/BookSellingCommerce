        ...
        <div className="promotion-main-container">
                    ...
                    <Modal.Body>
                        <Form>
                            <Row>
                                <Col>
                                    <Form.Group className="mb-3" controlId="formName">
                                        <Form.Label className="text-black text-size-fit">Nhập mã khuyến mãi</Form.Label>
                                        <Form.Control
                                            type="text"
                            ...
                            <Form.Group className="mb-3" controlId="formDetail">
                                <Form.Label className="text-black text-size-fit">Nhập chi tiết khuyến mãi</Form.Label>
                                <Form.Control
                                    type="text"
...

            {
                <Modal size="m" show={showEdit} onHide={handleCloseEdit}>
                    <Modal.Header className="background-header" closeButton>
                        <Modal.Title className="color-title text-center text-size-title">Chỉnh khuyến mãi</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form>
                            <Row>
