                    ...
                    <Modal.Body>
                        <Form>
                            <Form.Group className="mb-2" controlId="formName">
                                <Form.Label className="text-black text-size-fit">Nhập tên sản phẩm</Form.Label>
                                <Form.Control
                                    type="text"
                            ...
                            <Form.Group className="mb-2" controlId="formImage">
                                <Form.Label className="text-black text-size-fit">Chọn ảnh sản phẩm:</Form.Label>
                            ...
                            <Form.Group className="mb-2" controlId="formDetail">
                                <Form.Label className="text-black text-size-fit">Nhập chi tiết sản phẩm</Form.Label>
                                <Form.Control
                                    type="text"
                            ...
                            <Form.Group className="mb-2" controlId="formPrice">
                                <Form.Label className="text-black text-size-fit">Nhập giá sản phẩm</Form.Label>
                                <Form.Control
                                    type="number"
                            ...
                            <Form.Group className="mb-2" controlId="formCategory">
                                <Form.Label className="text-black text-size-fit">Chọn danh mục sản phẩm</Form.Label>
                                <Form.Control
                                    as="select"
                                    value={id_category}
